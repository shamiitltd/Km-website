      ...
      <div className="max-w-[95rem] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="max-w-[35rem]">
          ...
          <p className="text-gray-600 text-[17px] md:text-[19px] leading-relaxed mb-10">
            Kisan Mitra uses cutting-edge AI and data science to deliver
            accurate, reliable and actionable insights for farmers.
          </p>
          ...
          <ul className="space-y-4">
            {benefits.map((benefit, idx) => (
              <li key={idx} className="flex items-center gap-3">
                <svg
                  className="w-6 h-6 text-[#2C8C44] flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.5"
                  viewBox="0 0 24 24"
