  ...
  return (
    <section className="w-full py-6 md:py-12 px-6 md:px-12 lg:px-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="w-full lg:w-[46%] mb-8 lg:mb-0">
          ...
          <div className="flex flex-wrap gap-4">
            <button 
              ...
              className="flex items-center gap-3 bg-black text-white px-5 py-2.5 rounded-xl hover:scale-105 transition-transform shadow-lg cursor-pointer"
            >
        ...
        {/* Right Content Area (Image directly in natural page flow without special box) */}
        <div className="w-full lg:w-[50%] flex items-center justify-center">
          <img 
            src={appMockupPhones} 
            alt="Kisan Mitra App - Smart Farming in Your Pocket" 
