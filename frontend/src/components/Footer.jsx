    ...
    <footer className="bg-[#0A2213] text-gray-300 pt-12 pb-6 px-6 md:px-12 lg:px-24 w-full border-t border-[#1a4a2e]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-8 mb-12">
        ...
        <div className="lg:col-span-1">
          ...
          <ul className="flex flex-col gap-2 text-[12px]">
            <li><Link to="/about" className="hover:text-white transition-colors">About Us</Link></li>
            <li><Link to="/team" className="hover:text-white transition-colors">Meet Our Team</Link></li>
            <li><Link to="/careers" className="hover:text-white transition-colors">Careers</Link></li>
            <li><Link to="/blog" className="hover:text-white transition-colors">Press & Media</Link></li>
        ...
        <div className="lg:col-span-1">
          ...
          <ul className="flex flex-col gap-4 text-[12px]">
            <li className="flex items-start gap-2.5">
              ...
              <a href="mailto:support@kisanmitra.com" className="hover:text-white transition-colors">support@kisanmitra.com</a>
            </li>
            <li className="flex items-start gap-2.5">
              ...
              <a href="tel:+919548450539" className="hover:text-white transition-colors">+91 95484 50539</a>
            </li>
            <li className="flex items-start gap-2.5">
