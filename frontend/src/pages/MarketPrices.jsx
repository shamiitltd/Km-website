...
export default function MarketPrices() {
  ...
  const [selectedDate, setSelectedDate] = useState('Today (5 Sep 2026)');
  ...
  const [selectedStateTab, setSelectedStateTab] = useState('All');
  ...
  const fetchMarketDashboardData = async (opts = {}) => {
    try {
      setLoading(true);
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 relative">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 px-3 py-1 rounded-xl text-right">
                      ...
                      <span className="text-[10px] text-emerald-700 block font-medium">5 Sep 2026</span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
                  ...
                  <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option>Today (5 Sep 2026)</option>
                        <option>Yesterday (4 Sep 2026)</option>
                        <option>Weekly Avg (30 Aug - 5 Sep)</option>
                      </select>
