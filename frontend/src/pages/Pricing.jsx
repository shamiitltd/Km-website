...
export default function Pricing() {
    ...
    const handleSubscribe = async (e) => {
        ...
        if (!email.trim()) {
            setFeedback({
                type: 'warning',
                message: 'Please enter your email address to receive pricing launch alerts.'
            });
            setIsShaking(true);
                ...
                <div className="w-full max-w-xl mb-12">
                    {feedback?.type === 'success' ? (
                        feedback.alreadySubscribed ? (
                            <div className="bg-gradient-to-br from-amber-50 via-rose-50/50 to-amber-50/70 border border-amber-200/90 text-amber-950 px-7 py-5 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs animate-fade-in text-left">
                                <div className="flex items-center gap-3.5">
                                    <svg className="w-7 h-7 text-amber-700 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                            ...
                            <div className="bg-gradient-to-br from-emerald-50 via-emerald-50/90 to-teal-50 border border-emerald-200/90 text-[#123C26] px-8 py-5 rounded-2xl flex flex-col sm:flex-row items-center justify-center gap-3.5 shadow-xs animate-fade-in">
                        ...
                        <div className="w-full">
                            <form
                                ...
                                noValidate
                                className={`w-full bg-white p-2 sm:p-2.5 rounded-2xl flex flex-col sm:flex-row items-center gap-2 border shadow-md transition-all ${
                                    feedback?.type === 'warning'
                                        ? 'border-2 border-rose-400 focus-within:ring-4 focus-within:ring-rose-500/15'
                                        : 'border-gray-200 focus-within:ring-2 focus-within:ring-[#2C8C44]/50 focus-within:border-[#2C8C44]'
